...
module.exports = class Registrator
{
  constructor(ua, transport)
  {
    ...
    console.log({ ua, transport });
    this._registrationTimerDelay = ua.configuration.registration_timer_delay;
      ...
      onReceiveResponse : (response) =>
      {
        ...
        switch (true)
        {
          ...
          case /^2[0-9]{2}$/.test(response.status_code):
            ...
            }, !this._registrationTimerDelay ? (expires * 1000) - 5000 : this._registrationTimerDelay);
